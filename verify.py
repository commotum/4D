...
t_span = 1024 # This is equivalent to sequence length in standard RoPE
x_span = 512 # Just like t span but the max number of x positions our tokens can be at
y_span = 512 # Just like t span but the max number of y positions our tokens can be at
z_span = 512 # Just like t span but the max number of z positions our tokens can be at
